...
(function () {
    ...
    .box_1 {
        ...
        .up-new {
            ...
            z-index: 99999;
            cursor: pointer;
            background: url(https://1771245847.github.io/jx/favicon.ico) no-repeat;
        }
        </style>`
    var Interface = [
        { name: "Tt解析", id: "awesome1", url: "https://jx.yangtu.top/?url=" },
        { name: "夜幕解析", id: "awesome2", url: "https://www.yemu.xyz/?url=" },
        { name: "Nx解析", id: "awesome3", url: "https://jx.nnxv.cn/tv.php?url=" },
        { name: "虾米解析", id: "awesome4", url: "https://jx.xmflv.com/?url=" },
        { name: "爱豆解析", id: "awesome5", url: "https://jx.aidouer.net/?url=" },
